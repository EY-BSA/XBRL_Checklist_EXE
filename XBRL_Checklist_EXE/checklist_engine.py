...
GROSS_ACCOUNT_LIST = {
    'IntangibleAssetsUnderDevelopmentGross', 'BuildingsGross',
    'BuildingIncidentalFacilitiesGross', 'ConstructionInProgressGross',
    'ToolsAndEquipmentGross', 'SupplyFacilitiesGross',
    'ReceivablesOnConstructionContracts', 'ExchangeableBonds',
    'StructureGross', 'FinanceLeaseAssetGross', 'MachineryGross',
    'OtherIntangibleAssetsGross', 'OtherPropertyPlantAndEquipmentGross',
    'OtherInventoriesGross', 'CurrentFinanceLeaseReceivablesGross',
    'ShortTermLoans', 'ShortTermTradeReceivable', 'ShortTermOtherReceivables',
    'ShortTermAccruedIncome', 'ShortTermDueFromCustomersForContractWork',
    'ShortTermDepositsProvided', 'ShortTermPrepaidConstructionCosts',
    'ShortTermAdvancePayments', 'ShortTermPrepaidExpenses',
    'ShortTermDeferredAncillaryIncomeForLoans', 'LeaseholdDeposits',
    'ReceivablesAgent', 'LicencesAndFranchisesGross', 'RentalAssetGross',
    'IntangibleExplorationAndEvaluationAssetsGross', 'UnfinishedProgramGross',
    'GoodsInTransitGross', 'ByProductGross', 'ReceivablesRealestateSales',
    'BrandNamesGross', 'NonCurrentEmissionRightGross', 'NonCurrentBiologicalAssetsGross',
    'OfficeEquipmentGross', 'UsufructContributionAssetGross', 'MerchandiseGross',
    'ShipsGross', 'ProductionSuppliesGross', 'FittingGross', 'ExperimentMaterialGross',
    'BondWithWarrant', 'UtilityModelRightsGross', 'GoodwillGross',
    'FinishedHousingGross', 'FinishedProgramGross', 'LotGross', 'RawMaterialsGross',
    'CurrentEmissionRight', 'CurrentBiologicalAssetsGross',
    'TangibleExplorationAndEvaluationAssetsGross', 'RentStructureGross',
    'GrossCapitalisedResearchAndDevelopmentExpenseForBioindustry',
    'LongTermReceivablesOnConstructionContracts', 'LongTermAdvancesOnConstructionContracts',
    'LongTermContractReserve', 'NoncurrentFinanceLeaseReceivablesGross',
    'LongTermOtherGuaranteeDepositReceivedGross', 'LongTermLoansGross',
    'LongTermReceivablesAgent', 'LongTermTradePayablesGross',
    'LongTermTradeAndOtherNonCurrentReceivablesGross', 'LongTermTradeReceivablesGross',
    'LongTermOtherReceivablesGross', 'LongTermAccruedIncomeGross',
    'LongTermOtherPayablesGross', 'LongTermAccruedExpensesGross',
    'LongTermDueFromCustomersForContractWork', 'LongTermDepositsProvidedGross',
    'LongTermReceivablesRealestateSales', 'LongTermAdvancePaymentsGross',
    'LongTermPrepaidExpenses', 'LongTermAdvancesCustomers', 'LongTermRentReceivedInAdvance',
    'LongTermWithholdingsBanks', 'LongTermGuaranteeDepositWithholdings',
    'LongTermDeferredAncillaryIncomeForLoans', 'DeferredIncomeClassifiedAsNoncurrent',
    'LongTermGuaranteeDepositRentGross', 'LongTermLeaseholdDeposits', 'LongTermBorrowingsGross',
    'WorkInProgressGross',
    'CopyrightsPatentsAndOtherIndustrialPropertyRightsServiceAndOperatingRightsGross',
    'SuppliesGross', 'ElectronicAutomationDevelopmentGross', 'ElectronicFacilitiesGross',
    'TelexAndTelephoneSubscriptionRights', 'ConvertibleBonds',
    'ConvertibleRedeemablePreferredStockLiabilities', 'FinishedGoodsGross',
    'MastheadsAndPublishingTitlesGross', 'RecipesFormulaeModelsDesignsAndPrototypesGross',
    'FixturesAndFittingsGross', 'VehiclesGross', 'LandRightGross', 'MiningRightsGross',
    'ComputerSoftwareGross', 'LandGross', 'LandUseRightGross', 'InvestmentPropertyGross',
...
def run_all_checks(data, std=None) -> OrderedDict:
    ...
    return OrderedDict([
        ...
        ('2-5', _c2_5(rows, data)),
        ('2-6', _c2_6(rows, data)),
        ('3-1', _c3_1(data.axis_domain_rows, data)),
        ('3-2', _c3_2(rows, data)),
...
def _c2_6(rows, data):
    ...
    for row in rows:
        ...
        if not ('D835110' in table_num or 'D835115' in table_num):
            continue
        if '유효세율' not in row.get('Label(KO)', ''):
            continue
        if 'AverageEffectiveTaxRate' not in row.get('Name', ''):
...
def _c3_1(rows, data):
    ...
    for row in rows:
        ...
        status = 'CHECK' if (key2 is None or key_val != str(key2)) else 'OK'
...
def _c7_1(rows, data):
    ...
    Negate_Check = Negate_Check.sort_values(['_sort_consol', '_sort_sheet']).reset_index(drop=True)
